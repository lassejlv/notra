...
We provide multiple ways to interact with Notra:
...
<CardGroup cols={2}>
  ...
  <Card title="Rust SDK" icon="rust">
    Use the community `notra` crate for a type-safe Rust integration.
  </Card>
...
<Tip>
  The Rust SDK is community-maintained. Source and docs are available at
