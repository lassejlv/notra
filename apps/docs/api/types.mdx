...
The `notra` crate exports all types under `notra::models`. Import what you need:
...
<Tip>
  The Rust SDK ships with fully typed request builders and response structs — no
  manual type definitions needed. See
  [crates.io/crates/notra](https://crates.io/crates/notra) for the full API.
</Tip>
