...
date: "2026-02-21"
description: "Langfuse improved dashboard performance with v2 query optimizations, added bloom filter indexes for faster user and session lookups, enabled header-based direct writes to v4 event tables, and expanded event table filtering and batch tooling."
---
